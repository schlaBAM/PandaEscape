-----------------------------------------------------------------------------------------
--
-- transition.lua - transition scene after user hits continue in gameOver.lua
--
-----------------------------------------------------------------------------------------
...
function scene:create( event )
	...
	transition.to(plane2, {rotation = 13, alpha = 1, time=2200, x=display.contentWidth + 40, y = 10})
	
	local credText = "Panda is keeping up! Keep going!"
